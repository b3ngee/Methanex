...
INSERT INTO `PORTFOLIO` (`ID`, `MANAGER_ID`, `CLASSIFICATION_ID`, `NAME`)
VALUES
	(1, 2, 1, 'Product'),
	(2, 3, 2, 'Marketing');
...
VALUES
	(1, 1, 'Sales Tracker', 'UNDERWAY', 'AMBER', 10000.00, 7000.00, 5000.00, 4, 0, '03-01-2018', '04-30-2018', NULL),
	(2, 1, 'Sales Analytics Software', 'PRE_APPROVAL', 'RED', 0.00, 0.00, 0.00, 4, 0, '05-01-2018', '08-31-2018', NULL),
	(3, 2, 'Increase Sales by 10%', 'UNDERWAY', 'RED', 50000.00, 20000.00, 30000.00, 5, 0, '01-01-2018', '12-31-2018', NULL),
	(4, 2, 'Increase Brand Awareness by 15%', 'SEEKING_FUNDING', 'AMBER', 0.00, 0.00, 0.00, 5, 0, '06-01-2018', '12-31-2018', NULL);
